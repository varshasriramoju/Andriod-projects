...
public class Chineeseburger extends Activity {

	TextView quantityTextView,itemName;
	TextView totalCost;
	private int quantity=0;
	private int pricePerItem=220;
	Button button1,addButton,subButton,addToCartButton;
	
	protected void onCreate(Bundle savedInstanceState){
		super.onCreate(savedInstanceState);
		setContentView(R.layout.chineeseburger);
		...
		button1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent i=new Intent(Chineeseburger.this,Seven.class);
		...
		addToCartButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent i=new Intent(Chineeseburger.this,Cart.class);
