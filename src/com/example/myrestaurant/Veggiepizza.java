...
public class Veggiepizza extends Activity {
	TextView quantityTextView,itemName;
	TextView totalCost;
	private int quantity=0;
	private int pricePerItem=185;
	Button button1,addButton,subButton,addToCartButton;
	
	protected void onCreate(Bundle savedInstanceState){
		super.onCreate(savedInstanceState);
		setContentView(R.layout.veggiepizza);
		...
		button1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent i=new Intent(Veggiepizza.this,Seven.class);
		...
		addToCartButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent i=new Intent(Veggiepizza.this,Cart.class);
