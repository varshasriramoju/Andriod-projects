...
public class Siliconpizza extends Activity {
	TextView quantityTextView,itemName;
	TextView totalCost;
	private int quantity=0;
	private int pricePerItem=195;
	Button button1,addButton,subButton,addToCartButton;
	
	protected void onCreate(Bundle savedInstanceState){
		super.onCreate(savedInstanceState);
		setContentView(R.layout.siliconpizza);
		...
		button1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent i=new Intent(Siliconpizza.this,Seven.class);
		...
		addToCartButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent i=new Intent(Siliconpizza.this,Cart.class);
